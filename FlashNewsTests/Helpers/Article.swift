    ...
    static func getMocks() -> [Article] {
        return [
            Article(
                ...
                content: "Swift 6 introduces new capabilities for concurrency and improved performance, making it easier for developers to write efficient code."
            ),
            Article(
                ...
                content: "Stock markets across the world saw varied performances today, with tech stocks experiencing a small dip."
            ),
            Article(
                ...
                content: "According to recent studies, the new flu vaccine is effective against multiple strains and has a higher efficacy rate than previous versions."
            ),
            Article(
                ...
                content: "Companies like Google, Apple, and Amazon are increasingly focusing on AI, introducing new tools to enhance user experiences."
            ),
            Article(
                ...
                content: "Highlights include thrilling matches in the NBA, a surprising comeback in the Premier League, and new records in Olympic swimming trials."
            ),
            Article(
                ...
                content: "From plant-based alternatives to unique fusion dishes, this summer is full of bold flavors and culinary creativity."
            ),
            Article(
                ...
                content: "Scientists are excited about the recent findings, which provide more clues about Mars' geological history and potential for supporting life."
            ),
            Article(
                ...
                content: "Check out our list of highly anticipated films set to release this summer, featuring top actors and fresh storylines."
            ),
            Article(
                ...
                content: "Experts emphasize the need for global cooperation to mitigate effects on vulnerable regions and ecosystems."
            ),
            Article(
                ...
                content: "These advancements could revolutionize industries, from pharmaceuticals to cryptography, by performing complex calculations at unprecedented speeds."
            )
        ]
    }
}
